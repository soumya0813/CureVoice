const __vite__fileDeps=["./index.BfjYE92v.js","./index.BaT9MvtE.js","./index.BF3D-dVs.js","./index.DCjNkbVK.js","./index.6lD8qur-.js","./index.CBSMSmvZ.js","./frontmatter.Bz1VmAsK.js","./yaml.BMKOA8H-.js","./index.kYq6XS2l.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { I as IconButton, F as Check, G as Copy$1, B as Block, S as Static } from "./2.BAR5dNFu.js";
...
const lang_map = {
  python: () => __vitePreload(() => import("./index.BfjYE92v.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      __vitePreload(() => import("./index.BF3D-dVs.js"), true ? __vite__mapDeps([2,3,1,4,5]) : void 0, import.meta.url),
      __vitePreload(() => import("./frontmatter.Bz1VmAsK.js"), true ? __vite__mapDeps([6,7]) : void 0, import.meta.url)
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => __vitePreload(() => import("./index.kYq6XS2l.js"), true ? __vite__mapDeps([8,1]) : void 0, import.meta.url).then((m) => m.json()),
  html: () => __vitePreload(() => import("./index.DCjNkbVK.js"), true ? __vite__mapDeps([3,1,4,5]) : void 0, import.meta.url).then((m) => m.html()),
  css: () => __vitePreload(() => import("./index.6lD8qur-.js"), true ? __vite__mapDeps([4,1]) : void 0, import.meta.url).then((m) => m.css()),
  javascript: () => __vitePreload(() => import("./index.CBSMSmvZ.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then((m) => m.javascript()),
  jinja2: () => __vitePreload(() => import("./jinja2.2Vo2sGef.js"), true ? [] : void 0, import.meta.url).then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => __vitePreload(() => import("./index.CBSMSmvZ.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then(

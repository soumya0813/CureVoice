...
import { a as TABS } from "./Tabs.CgLMwdR5.js";
import { k as Index$1 } from "./2.BAR5dNFu.js";
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, selected_tab_index, (value) => $$invalidate(11, $selected_tab_index = value));
  let tab_index;
  onMount(() => {
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*label, id, elem_id, visible, interactive, order*/
    909) {
      $$invalidate(10, tab_index = register_tab({ label, id, elem_id, visible, interactive }, order));
    }

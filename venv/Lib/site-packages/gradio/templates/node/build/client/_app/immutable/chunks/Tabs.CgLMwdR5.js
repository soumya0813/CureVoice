...
function create_if_block_2(ctx) {
  ...
  let t0_value = (
    /*t*/
    ((_a = ctx[32]) == null ? void 0 : _a.label) + ""
  );
  let t0;
  let t1;
  let t = (
  ...
  return {
    ...
    p(new_ctx, dirty) {
      ...
      ((_a2 = ctx[32]) == null ? void 0 : _a2.label) + ""))
...
function create_each_block_2(ctx) {
  ...
  let if_block = (
    /*t*/
    ((_a = ctx[32]) == null ? void 0 : _a.visible) && create_if_block_2(ctx)
  );
  return {
    c() {
      if (if_block)
    ...
    p(ctx2, dirty) {
      ...
      if (
        /*t*/
        (_a2 = ctx2[32]) == null ? void 0 : _a2.visible
      ) {
        if (if_block) {
...
function create_each_block_1(ctx) {
  ...
  let if_block = (
    /*t*/
    ((_a = ctx[32]) == null ? void 0 : _a.visible) && create_if_block_1(ctx)
  );
  return {
    c() {
      if (if_block)
  ...
  return {
    ...
    h() {
      ...
      toggle_class(
        ...
        "selected",
        /*t*/
        ((_a2 = ctx[32]) == null ? void 0 : _a2.id) === /*$selected_tab*/
        ctx[6]
      );
    },
    m(target, anchor) {
    ...
    p(new_ctx, dirty) {
      ...
      320) {
        toggle_class(
          ...
          "selected",
          /*t*/
          ((_b = ctx[32]) == null ? void 0 : _b.id) === /*$selected_tab*/
          ctx[6]
        );
      }
    },
...
function instance($$self, $$props, $$invalidate) {
  ...
  const selected_tab_index = writable(tabs.findIndex((t) => (t == null ? void 0 : t.id) === selected) || 0);
  ...
  setContext(TABS, {
    register_tab: (tab, order) => {
      $$invalidate(3, tabs[order] = tab, tabs);
    ...
    unregister_tab: (tab, order) => {
      ...
      $$invalidate(3, tabs[order] = null, tabs);
    },
    selected_tab,
    selected_tab_index
  });
  function change_tab(id) {
    const tab_to_activate = tabs.find((t) => (t == null ? void 0 : t.id) === id);
    if (id !== void 0 && tab_to_activate && tab_to_activate.interactive && tab_to_activate.visible && $selected_tab !== tab_to_activate.id) {
      ...
      set_store_value(selected_tab_index, $selected_tab_index = tabs.findIndex((t) => (t == null ? void 0 : t.id) === id), $selected_tab_index);
      dispatch("change");
  ...
  function handle_overflow_has_selected_tab(selected_tab2) {
    if (selected_tab2 === false)
      return false;
    return overflow_tabs.some((t) => (t == null ? void 0 : t.id) === selected_tab2);
  }
  ...
  const click_handler_2 = (t) => change_tab(t == null ? void 0 : t.id);

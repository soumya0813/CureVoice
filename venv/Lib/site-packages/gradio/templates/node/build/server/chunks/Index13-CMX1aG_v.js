import { c as create_ssr_component, v as validate_component, a as createEventDispatcher, e as escape, b as add_attribute, o as onDestroy } from './ssr-fyTaU2Wq.js';
import { B as Block, S as Static, f as BlockLabel, N as Code$2, h as Empty, j as IconButton, w as Copy$1, D as Download$1, i as IconButtonWrapper } from './2-2VJ3rG_4.js';
import { D as DownloadLink } from './DownloadLink-BKK_IWmU.js';
import Example from './Example6-DKMDKr0z.js';
...
const lang_map = {
  python: () => import('./index28-BuG7V9r1.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index29-DqshImbe.js'),
      import('./frontmatter-C8qmskj1.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index33-J_b9t1_t.js').then((m) => m.json()),
  html: () => import('./index30-B22KzWYs.js').then((m) => m.html()),
  css: () => import('./index31-C97qlS--.js').then((m) => m.css()),
  javascript: () => import('./index32-Cr7BgO4r.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index32-Cr7BgO4r.js').then(
...
//# sourceMappingURL=Index13-CMX1aG_v.js.map

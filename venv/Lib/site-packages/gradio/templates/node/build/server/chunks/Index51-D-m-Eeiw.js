import { c as create_ssr_component, v as validate_component, b as add_attribute, m as missing_component, a as createEventDispatcher } from './ssr-fyTaU2Wq.js';
import { B as Block, S as Static, f as BlockLabel, v as File$1, h as Empty, U as UploadText, i as IconButtonWrapper, j as IconButton, A as Undo, D as Download } from './2-2VJ3rG_4.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-lHSlFp8z.js';
export { default as BaseExample } from './Example17-D4rTevcB.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-CZT07awj.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-DTHXRnfv.js');
  return module.default;
}
...
//# sourceMappingURL=Index51-D-m-Eeiw.js.map

...
import { B as Block, S as Static, f as BlockLabel, C as Chat, i as IconButtonWrapper, j as IconButton, q as Community, r as Trash, t as MarkdownCode, M as Music, v as File$1, w as Copy, x as ScrollDownArrow, y as Check, z as Clear, R as Retry, A as Undo, G as Edit, H as DropdownCircularArrow } from './2-2VJ3rG_4.js';
...
const Thought = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="thought-group svelte-i6yrue"><div class="${["title svelte-i6yrue", "expanded"].join(" ").trim()}"${add_attribute("aria-busy", thought_node.content === "" || thought_node.content === null, 0)} role="button" tabindex="0"><span class="arrow svelte-i6yrue"${add_styles({
    ...
    {},
    {}
  )} ${thought_node.content === "" || thought_node.content === null || thought_node.metadata?.status === "pending" ? `<span class="loading-spinner svelte-i6yrue"></span>` : ``} ${thought_node?.metadata?.duration ? `<span class="duration svelte-i6yrue">${Number.isInteger(thought_node.metadata.duration) ? `${escape(thought_node.metadata.duration)}s` : `${thought_node.metadata.duration >= 0.1 ? `${escape(thought_node.metadata.duration.toFixed(1))}s` : `${escape((thought_node.metadata.duration * 1e3).toFixed(1))}ms`}`}</span>` : ``}</div> ${`<div class="content svelte-i6yrue">${validate_component(MessageContent, "MessageContent").$$render(
    $$result,
    {
      message: thought_node,
      sanitize_html,
...
const css$4 = {
  code: ".message.svelte-u94xf4.svelte-u94xf4{position:relative;width:100%}.avatar-container.svelte-u94xf4.svelte-u94xf4{flex-shrink:0;border-radius:50%;border:1px solid var(--border-color-primary);overflow:hidden}.avatar-container.svelte-u94xf4 img{object-fit:cover}.flex-wrap.svelte-u94xf4.svelte-u94xf4{display:flex;flex-direction:column;width:calc(100% - var(--spacing-xxl));max-width:100%;color:var(--body-text-color);font-size:var(--chatbot-text-size);overflow-wrap:break-word;width:100%;height:100%}.component.svelte-u94xf4.svelte-u94xf4{padding:0;border-radius:var(--radius-md);width:fit-content;overflow:hidden}.component.gallery.svelte-u94xf4.svelte-u94xf4{border:none}.message-row.svelte-u94xf4 .svelte-u94xf4:not(.avatar-container) img{margin:var(--size-2);max-height:300px}.file-pil.svelte-u94xf4.svelte-u94xf4{display:block;width:fit-content;padding:var(--spacing-sm) var(--spacing-lg);border-radius:var(--radius-md);background:var(--background-fill-secondary);color:var(--body-text-color);text-decoration:none;margin:0;font-family:var(--font-mono);font-size:var(--text-sm)}.file.svelte-u94xf4.svelte-u94xf4{width:auto !important;max-width:fit-content !important}@media(max-width: 600px) or (max-width: 480px){.component.svelte-u94xf4.svelte-u94xf4{width:100%}}.message.svelte-u94xf4 .prose{font-size:var(--chatbot-text-size)}.message-bubble-border.svelte-u94xf4.svelte-u94xf4{border-width:1px;border-radius:var(--radius-md)}.panel-full-width.svelte-u94xf4.svelte-u94xf4{width:100%}.message-markdown-disabled.svelte-u94xf4.svelte-u94xf4{white-space:pre-line}.user.svelte-u94xf4.svelte-u94xf4{border-radius:var(--radius-md);align-self:flex-end;border-bottom-right-radius:0;box-shadow:var(--shadow-drop);border:1px solid var(--border-color-accent-subdued);background-color:var(--color-accent-soft);padding:var(--spacing-sm) var(--spacing-xl)}.bot.svelte-u94xf4.svelte-u94xf4{border:1px solid var(--border-color-primary);border-radius:var(--radius-md);border-color:var(--border-color-primary);background-color:var(--background-fill-secondary);box-shadow:var(--shadow-drop);align-self:flex-start;text-align:right;border-bottom-left-radius:0;padding:var(--spacing-sm) var(--spacing-xl)}.bot.svelte-u94xf4.svelte-u94xf4:has(.table-wrap){border:none;box-shadow:none;background:none}.panel.svelte-u94xf4 .user.svelte-u94xf4 *{text-align:right}.message-row.svelte-u94xf4.svelte-u94xf4{display:flex;position:relative}.bubble.svelte-u94xf4.svelte-u94xf4{margin:calc(var(--spacing-xl) * 2);margin-bottom:var(--spacing-xl)}.bubble.user-row.svelte-u94xf4.svelte-u94xf4{align-self:flex-end;max-width:calc(100% - var(--spacing-xl) * 6)}.bubble.bot-row.svelte-u94xf4.svelte-u94xf4{align-self:flex-start;max-width:calc(100% - var(--spacing-xl) * 6)}.bubble.svelte-u94xf4 .user-row.svelte-u94xf4{flex-direction:row;justify-content:flex-end}.bubble.svelte-u94xf4 .with_avatar.user-row.svelte-u94xf4{margin-right:calc(var(--spacing-xl) * 2) !important}.bubble.svelte-u94xf4 .with_avatar.bot-row.svelte-u94xf4{margin-left:calc(var(--spacing-xl) * 2) !important}.bubble.svelte-u94xf4 .with_opposite_avatar.user-row.svelte-u94xf4{margin-left:calc(var(--spacing-xxl) + 35px + var(--spacing-xxl))}.panel.svelte-u94xf4.svelte-u94xf4{margin:0;padding:calc(var(--spacing-lg) * 2) calc(var(--spacing-lg) * 2)}.panel.bot-row.svelte-u94xf4.svelte-u94xf4{background:var(--background-fill-secondary)}.panel.svelte-u94xf4 .with_avatar.svelte-u94xf4{padding-left:calc(var(--spacing-xl) * 2) !important;padding-right:calc(var(--spacing-xl) * 2) !important}.panel.svelte-u94xf4 .panel-full-width.svelte-u94xf4{width:100%}.panel.svelte-u94xf4 .user.svelte-u94xf4 *{text-align:right}.flex-wrap.svelte-u94xf4.svelte-u94xf4{display:flex;flex-direction:column;max-width:100%;color:var(--body-text-color);font-size:var(--chatbot-text-size);overflow-wrap:break-word}@media(max-width: 480px){.user-row.bubble.svelte-u94xf4.svelte-u94xf4{align-self:flex-end}.bot-row.bubble.svelte-u94xf4.svelte-u94xf4{align-self:flex-start}.message.svelte-u94xf4.svelte-u94xf4{width:100%}}.avatar-container.svelte-u94xf4.svelte-u94xf4{align-self:flex-start;position:relative;display:flex;justify-content:flex-start;align-items:flex-start;width:35px;height:35px;flex-shrink:0;bottom:0;border-radius:50%;border:1px solid var(--border-color-primary)}.user-row.svelte-u94xf4>.avatar-container.svelte-u94xf4{order:2}.user-row.bubble.svelte-u94xf4>.avatar-container.svelte-u94xf4{margin-left:var(--spacing-xxl)}.bot-row.bubble.svelte-u94xf4>.avatar-container.svelte-u94xf4{margin-left:var(--spacing-xxl)}.panel.user-row.svelte-u94xf4>.avatar-container.svelte-u94xf4{order:0}.bot-row.bubble.svelte-u94xf4>.avatar-container.svelte-u94xf4{margin-right:var(--spacing-xxl);margin-left:0}.avatar-container.svelte-u94xf4:not(.thumbnail-item) img{width:100%;height:100%;object-fit:cover;border-radius:50%;padding:6px}.selectable.svelte-u94xf4.svelte-u94xf4{cursor:pointer}@keyframes svelte-u94xf4-dot-flashing{0%{opacity:0.8}50%{opacity:0.5}100%{opacity:0.8}}.message.svelte-u94xf4 .preview{object-fit:contain;width:95%;max-height:93%}.image-preview.svelte-u94xf4.svelte-u94xf4{position:absolute;z-index:999;left:0;top:0;width:100%;height:100%;overflow:auto;background-color:rgba(0, 0, 0, 0.9);display:flex;justify-content:center;align-items:center}.image-preview.svelte-u94xf4 svg{stroke:white}.image-preview-close-button.svelte-u94xf4.svelte-u94xf4{position:absolute;top:10px;right:10px;background:none;border:none;font-size:1.5em;cursor:pointer;height:30px;width:30px;padding:3px;background:var(--bg-color);box-shadow:var(--shadow-drop);border:1px solid var(--button-secondary-border-color);border-radius:var(--radius-lg)}.message.svelte-u94xf4>div.svelte-u94xf4{width:100%}.html.svelte-u94xf4.svelte-u94xf4{padding:0;border:none;background:none}.panel.svelte-u94xf4 .bot.svelte-u94xf4,.panel.svelte-u94xf4 .user.svelte-u94xf4{border:none;box-shadow:none;background-color:var(--background-fill-secondary)}textarea.svelte-u94xf4.svelte-u94xf4{background:none;border-radius:var(--radius-lg);border:none;display:block;max-width:100%}.user.svelte-u94xf4 textarea.svelte-u94xf4{border-bottom-right-radius:0}.bot.svelte-u94xf4 textarea.svelte-u94xf4{border-bottom-left-radius:0}.user.svelte-u94xf4 textarea.svelte-u94xf4:focus{outline:2px solid var(--border-color-accent)}.bot.svelte-u94xf4 textarea.svelte-u94xf4:focus{outline:2px solid var(--border-color-primary)}.panel.user-row.svelte-u94xf4.svelte-u94xf4{background-color:var(--color-accent-soft)}.panel.svelte-u94xf4 .user-row.svelte-u94xf4,.panel.svelte-u94xf4 .bot-row.svelte-u94xf4{align-self:flex-start}.panel.svelte-u94xf4 .user.svelte-u94xf4 *,.panel.svelte-u94xf4 .bot.svelte-u94xf4 *{text-align:left}.panel.svelte-u94xf4 .user.svelte-u94xf4{background-color:var(--color-accent-soft)}.panel.svelte-u94xf4 .user-row.svelte-u94xf4{background-color:var(--color-accent-soft);align-self:flex-start}.panel.svelte-u94xf4 .message.svelte-u94xf4{margin-bottom:var(--spacing-md)}",
...
const Message = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${[
    "message-row " + escape(layout, true) + " " + escape(role, true) + "-row svelte-u94xf4",
    (avatar_img !== null ? "with_avatar" : "") + " " + (opposite_avatar_img !== null ? "with_opposite_avatar" : "")
  ].join(" ").trim()}">${avatar_img !== null ? `<div class="avatar-container svelte-u94xf4">${validate_component(Image$1, "Image").$$render(
    $$result,
    {
      class: "avatar-image",
      src: avatar_img?.url,
    ...
    "flex-wrap svelte-u94xf4",
    (role ? "role" : "") + " " + (messages[0].type === "component" ? "component-wrap" : "")
  ].join(" ").trim()}"><div class="${[
    escape(null_to_empty(display_consecutive_in_same_bubble ? role : ""), true) + " svelte-u94xf4",
    display_consecutive_in_same_bubble ? "message" : ""
  ].join(" ").trim()}">${each(messages, (message, thought_index) => {
    return `<div class="${[
      "message " + escape(!display_consecutive_in_same_bubble ? role : "", true) + " svelte-u94xf4",
    ...
    ].join(" ").trim()}">${in_edit_mode && thought_index === messages.length - 1 && message.type === "text" ? ` <textarea class="edit-textarea svelte-u94xf4" autofocus${add_styles({
...
//# sourceMappingURL=Index56-CrHGCU-B.js.map
